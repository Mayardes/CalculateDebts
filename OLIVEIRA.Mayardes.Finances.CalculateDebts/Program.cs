...
namespace OLIVEIRA.Mayardes.Finances.CalculateDebts
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            claro = Convert.ToDecimal(Console.ReadLine().Replace(",", "."), CultureInfo.InvariantCulture);
            ...
            creditcard = Convert.ToDecimal(Console.ReadLine().Replace(",", "."), CultureInfo.InvariantCulture);
            ...
            posGraduate = Convert.ToDecimal(Console.ReadLine().Replace(",", "."), CultureInfo.InvariantCulture);
            ...
            gym = Convert.ToDecimal(Console.ReadLine().Replace(",", "."), CultureInfo.InvariantCulture);
            bills.Add(new BillsModel() { Enterprise = "Gym", Sector = Enums.SectorEnum.Health, Value = gym });

            Console.WriteLine("Water:");
            waterBill = Convert.ToDecimal(Console.ReadLine().Replace(",", "."), CultureInfo.InvariantCulture);
            ...
            while (opt == 'S')
            {
                ...
                Console.WriteLine("1 - Communication/NET");
                Console.WriteLine("2 - Water");
                Console.WriteLine("3 - Car");
                Console.WriteLine("4 - Health/Gym");
                Console.WriteLine("5 - School/Edicational");
                ...
                value = Convert.ToDecimal(Console.ReadLine().Replace(",", "."), CultureInfo.InvariantCulture);
            ...
            Console.WriteLine($"Value Total Expensives R$: {Calculate.GetValueTotalExpenses()}");
            Console.WriteLine("-------------------------------------------------");

            Console.WriteLine("How much is your salary?");
            GenerateReport.salary = Convert.ToDecimal(Console.ReadLine());


            Console.WriteLine("");
            Console.WriteLine("Would like to generate a file text? [S/N]");
            gen = Convert.ToChar(Console.ReadLine().ToUpper());


            if (gen == 'S')
                GenerateReport.GenerateFile(bills);
